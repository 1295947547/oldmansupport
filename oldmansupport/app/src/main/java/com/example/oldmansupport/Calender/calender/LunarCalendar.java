...
import com.example.oldmansupport.Calender.calender.SolarTerm;
...
public class LunarCalendar {
	...
	@SuppressLint("DefaultLocale")
	public com.example.oldmansupport.database.CalendarTransfer getSubDate(CalendarTransfer lastTrans,
