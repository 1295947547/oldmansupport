        ...
        switch (view.getId()) {
            ...
            case R.id.bt_registeractivity_register:    //注册按钮
                ...
                if(TextUtils.isEmpty(phonenumber)){
                    Toast toast=Toast.makeText(RegisterActivity.this,"电话号码不能为空",Toast.LENGTH_SHORT);
                    toast.show();
                }
                else if(!phonenumber.matches(telRegex)){
                    Toast toast=Toast.makeText(RegisterActivity.this,"电话号码格式不正确，请重新输入",Toast.LENGTH_SHORT);
                    toast.show();
                }

                else if(!password.equals(password2)){
                    Toast toast=Toast.makeText(RegisterActivity.this,"两次的密码不一致",Toast.LENGTH_SHORT);
                    toast.show();
                }
                else{
                    canRegister=true;
